...
Example prompt:
"Use process-merge skill to merge these three requirements documents: [doc1.md], [doc2.pdf], [doc3.docx]. Apply conservative merge strategy with manual conflict resolution for high-impact conflicts."
```
