...
### Must Have
- [x] Complexity metrics calculated per hierarchy level
- [x] Warnings when diagram exceeds recommended interaction count
- [x] Decomposition suggestions based on participant type and interaction count
- [x] Hierarchy depth and breadth tracking
